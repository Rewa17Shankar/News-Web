...
const AllNews = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://api.mediastack.com/v1/news?access_key=${apiKey}&countries=in&limit=${limit}&offset=${offset}`
        );
    ...
    return () => clearTimeout(timer); // Cleanup on unmount or currentPage change
  }, [currentPage]);
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-8">
      ...
      {loading ? (
        <p className="text-center text-blue-800 font-medium text-lg">Loading news...</p>
      ) : (
